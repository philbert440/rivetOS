  ...
  return {
    ...
    handler: async (ctx) => {
      ...
      try {
        ...
        ctx.metadata.autoFormat = { file: filePath, status: 'skipped', reason: 'prettier not available' };
      }
    },
  ...
  return {
    ...
    handler: async (ctx) => {
      ...
      try {
        ...
        ctx.metadata.autoLint = { file: filePath, status: 'skipped', reason: 'eslint not available' };
      }
    },
  ...
  return {
    ...
    handler: async (ctx) => {
      ...
      try {
        ...
        ctx.metadata.autoTest = { file: filePath, status: 'skipped', reason: 'test runner not available' };
      }
    },
 ...
 */
export function createAutoGitCheckHook(config: AutoActionConfig): HookRegistration<ToolAfterContext> {
  return {
    id: 'auto:git-check',
    event: 'tool:after',
    handler: async (ctx) => {
 ...
 */
export function createCustomActionHook(action: AutoAction, config: AutoActionConfig): HookRegistration<ToolAfterContext> {
  return {
    id: `auto:${action.id}`,
    event: 'tool:after',
    handler: async (ctx) => {
