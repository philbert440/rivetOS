#!/usr/bin/env bash
# rivet-memory-mcp — launch the RivetOS MCP server in stdio mode for the pi CLI.
#
# Usage in pi (mcp.json in the config dir):
#   {
#     "mcpServers": {
#       "rivetos": {
#         "command": "/path/to/rivetos/integrations/pi/rivet-memory/bin/rivet-memory-mcp.sh"
#       }
#     }
#   }
#
