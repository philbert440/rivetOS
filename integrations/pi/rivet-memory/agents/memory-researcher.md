...
- Prompt says **"routed user: <name> (<id>)"**: your memory tools are already
  routed to *that user's* database (#561), so treat findings as their history, never
...
3. Synthesize across agents (`rivet-claude`, `rivet-hermes`, `rivet-grok`, `rivet-kimi`, `rivet-gpt`, `rivet-deepseek`, etc.).
