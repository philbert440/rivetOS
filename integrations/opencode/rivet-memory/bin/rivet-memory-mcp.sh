#!/usr/bin/env bash
# rivet-memory-mcp — launch the RivetOS MCP server in stdio mode for OpenCode CLI.
#
# Usage in OpenCode (mcp block in opencode.json):
#   {
#     "mcp": {
#       "rivetos": {
#         "type": "local",
#         "command": ["bash", "/path/to/rivetos/integrations/opencode/rivet-memory/bin/rivet-memory-mcp.sh"],
#         "enabled": true
#       }
#     }
#   }
