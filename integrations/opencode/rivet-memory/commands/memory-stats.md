...
Shows conversation counts, message volume, coverage by agent (`rivet-claude`, `rivet-hermes`, `rivet-grok`, `rivet-kimi`, `rivet-gpt`, `rivet-glm`, etc.), compaction status, and embedding queue health.
