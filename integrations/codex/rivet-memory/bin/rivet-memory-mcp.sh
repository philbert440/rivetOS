#!/usr/bin/env bash
# rivet-memory-mcp — launch the RivetOS MCP server in stdio mode for Codex CLI.
#
# Usage in Codex (mcp.json in the config dir, or config.toml [mcp_servers]):
#   {
#     "mcpServers": {
#       "rivetos": {
#         "command": "/path/to/rivetos/integrations/codex/rivet-memory/bin/rivet-memory-mcp.sh"
#       }
#     }
#   }
#
