#!/usr/bin/env bash
# rivet-memory-mcp — launch the RivetOS MCP server in stdio mode for Qwen Code.
#
# Usage in qwen-extension.json:
#   {
#     "mcpServers": {
#       "rivetos": {
#         "command": "/path/to/rivetos/integrations/qwen-code/rivet-memory/bin/rivet-memory-mcp.sh"
#       }
#     }
#   }
#
