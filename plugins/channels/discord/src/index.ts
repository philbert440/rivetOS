 ...
 * - Thread support (create + reply) — threads inherit parent channel binding
 * - Typing indicators (auto start/stop around message handling)
...
export class DiscordChannel implements Channel {
  ...
  private buildKeyboard(buttons: Button[][]): ActionRowBuilder<ButtonBuilder> {
