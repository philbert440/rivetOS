-- 0001_baseline.sql — captures the production schema as of CT 110 dump (2026-04-26)
-- Source of truth for the rivetos memory store. All future schema changes
-- go in subsequent migrations (0002, 0003, ...). This file is never edited
-- after release; it represents the v0.4 baseline.
