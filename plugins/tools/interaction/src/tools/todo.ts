...
export function createTodoTool(): Tool {
  ...
  return {
    name: 'todo',
    description: 'Session-scoped task list. Track multi-step plans with add/update/complete/remove/list operations.',
    parameters: {
      type: 'object',
      properties: {
        operation: {
    ...
    async execute(args: Record<string, unknown>, _signal?: AbortSignal, _context?: ToolContext): Promise<string> {
