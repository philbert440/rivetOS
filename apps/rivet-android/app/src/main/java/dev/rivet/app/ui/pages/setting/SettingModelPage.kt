...
fun SettingModelPage(vm: SettingVM = koinViewModel()) {
    ...
    val showAdvanced = settings.developerMode
    val pageCount = if (showAdvanced) 2 else 1
    ...
    Scaffold(
        topBar = {
            LargeFlexibleTopAppBar(
                title = { Text(stringResource(R.string.setting_page_agent)) },
        ...
        HorizontalPager(
            ...
            userScrollEnabled = showAdvanced,
        ) { page ->
            when (page) {
                0 -> ModelSettingsPage(
                    settings = settings,
    ...
    LazyColumn(
        ...
        item {
            ModelFeatureCard(
                ...
                title = { Text(stringResource(R.string.setting_page_agent), maxLines = 1) },
                description = { Text(stringResource(R.string.setting_page_agent_desc)) },
                actions = {
                    ModelSelector(
