...
import dev.rivet.app.WEB_SERVER_NOTIFICATION_CHANNEL_ID
...
class WebServerService : Service() {
    ...
    companion object {
        const val ACTION_START = "dev.rivet.app.action.WEB_SERVER_START"
        const val ACTION_STOP = "dev.rivet.app.action.WEB_SERVER_STOP"
