...
import dev.rivet.common.http.AcceptLanguageBuilder
import dev.rivet.app.BuildConfig
import dev.rivet.app.data.ai.RequestLoggingInterceptor
import dev.rivet.app.data.ai.transformers.AssistantTemplateLoader
...
import dev.rivet.app.data.db.migrations.Migration_11_12
import dev.rivet.app.data.db.migrations.Migration_13_14
import dev.rivet.app.data.db.migrations.Migration_14_15
import dev.rivet.app.data.db.migrations.Migration_15_16
...
val dataSourceModule = module {
    ...
    single {
        ...
        Room.databaseBuilder(context, AppDatabase::class.java, "rivet_hub")
    ...
    single { RivetNodeInspector(context = get(), agentMcpReader = get()) }
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                if (originalRequest.header(HttpHeaders.UserAgent) == null) {
                    requestBuilder.addHeader(HttpHeaders.UserAgent, "RivetHub-Android/${BuildConfig.VERSION_NAME}")
                }
