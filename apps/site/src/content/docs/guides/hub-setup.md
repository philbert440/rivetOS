...
(`claude-code`, `grok-build`, `kimi-code`, `hermes`, `codex`, `opencode`, `pi`, `qwen-code`) via the gateway contract.
...
Implemented headless executors today: `claude-code`, `kimi-code`, `pi`, `qwen-code`. Prefer those
...
# claude-code, grok-build, hermes, kimi-code, codex, opencode, pi, qwen-code
# roster commands: claude, grok, hermes, kimi, codex, opencode, pi, qwen
