 ...
 * adapter matrix (#709): claude, kimi, grok, hermes, codex, opencode, pi, qwen.
 */
fun isLiveTurnStore(command: String): Boolean {
    val c = command.lowercase()
    return listOf("claude", "kimi", "grok", "hermes", "codex", "opencode", "pi", "qwen").any { c == it || c.startsWith(it) }
}
