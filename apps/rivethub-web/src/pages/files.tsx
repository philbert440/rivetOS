  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <p className="mb-4 text-sm text-ink-dim">
        Cross-node collaboration tree: plans, the shared RivetOS clone, projects, meetings — neutral
        ground, not any agent&apos;s personal workspace.
      </p>
      ...
      <div className="rounded border border-line bg-panel-2/50 px-4 py-3 font-mono text-xs text-ink-dim">
        ...
        <span className="text-em">/rivet-shared</span> via the node gateway (path-fenced; no
        secrets, no <span className="text-ink">~/.rivetos</span>).
      </div>
    </div>
  )
}
