...
| Key      | Type   | Default     | Description                                                                                                                                                 |
| -------- | ------ | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `host`   | string | `0.0.0.0`   | Bind address for the standalone agent-channel HTTP listener. Omitted = all interfaces. `rivetos local` / `RIVETOS_MODE=workspace` bind `127.0.0.1`.          |
